        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-beige text-black font-semibold rounded-lg hover:bg-beige/90 transition-colors duration-200">
                Start Your Project
              </button>
              <button className="px-8 py-4 border border-beige text-beige font-semibold rounded-lg hover:bg-beige/10 transition-colors duration-200">
                View Our Work
              </button>
            </div>
          </motion.div>
